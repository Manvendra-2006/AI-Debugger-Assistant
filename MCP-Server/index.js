        ...
        new Promise((resolve) =>
            setTimeout(() => resolve({
                content: [
                    {
                        type: 'text',
                        text: `Tool timed out after ${seconds} seconds`
                    }
                ]
            }), seconds * 1000)
        )
...
app.get("/sse", async (req, res) => {
    ...
    try {
        ...
        // HAR CLIENT KE LIYE NEW MCP SERVER
        ...
        server.tool(
            ...
            async ({ directorypath }) => {
                ...
                console.log("Listing files:", directorypath)
        ...
        server.tool(
            ...
            async ({ directoryPath, keyword }) => {
                ...
                return withTimeout(
                    searchCodebase(directoryPath, keyword),
                    15
                )
            }
        )
...
app.listen(process.env.PORT, () => {
    ...
    console.log(
        `MCP Server running on port ${process.env.PORT}`
    )
})
